...
@section('content')
    ...
    @include('beautymail::templates.minty.contentStart')
        ...
        <tr>
            <td class="paragraph">
            If you have any questions or need assistance, our support team is just an email away at info@lazim.ae. Remember, you can always manage your email preferences by visiting your account settings.
            </td>
        </tr>
        <tr>
            <td width="100%" height="25"></td>
