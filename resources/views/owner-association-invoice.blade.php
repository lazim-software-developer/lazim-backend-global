                ...
                <table class="w-full text-left border-collapse" style="border: 1px solid #ddd; border-collapse: collapse;">
                    <thead>
                        <tr>
                            ...
                            @if ($data->quantity)
                            <th class="border-b-2 border-gray-300 p-2 text-xs text-gray-600" style="border: 1px solid #ddd; text-align: center;">Quantity</th>
                            @endif
                    ...
                    <tbody>
                        <tr>
                            ...
                            @if ($data->quantity)
                            <td class="p-2" style="border: 1px solid #ddd; text-align: center;">{{$data->quantity}}</td>
                            @endif
                            <td class="p-2" style="border: 1px solid #ddd; padding: 8px; text-align: center;">{{$data->rate}}</td>
                            <td class="p-2" style="border: 1px solid #ddd; text-align: center;">
                                {{$data->quantity ? $data->quantity * $data->rate : $data->rate}}
                            </td>
                        </tr>
            ...
            <div class="flex justify-end mt-6">
                <table class="w-1/2 text-left border-collapse" style="border: 1px solid #ddd; border-collapse: collapse;">
                    <tr>
                        ...
                        <td class="p-2 text-sm text-gray-600" style="border: 1px solid #ddd; text-align: center;">
                            {{$data->quantity ? $data->quantity * $data->rate : $data->rate}}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="p-2 text-sm text-gray-600" style="border: 1px solid #ddd; text-align: center;">
                            {{($data->quantity ? $data->quantity * $data->rate : $data->rate) * $data->tax / 100}}
                        </td>
                    </tr>
                    <tr>
