...
class FacilityPolicy
{
    ...
    {
        return $user->can('view_any_master::facility');
    }
     ...
     *
     * @param  \App\Models\User\User  $user
     * @param  \App\Models\Master\Facility  $facility
     * @return bool
     */
    public function view(User $user, Facility $facility): bool
    {
        return $user->can('view_master::facility');
    }
    ...
    {
        return $user->can('create_master::facility');
    }
    ...
    {
        return $user->can('update_master::facility');
    }
