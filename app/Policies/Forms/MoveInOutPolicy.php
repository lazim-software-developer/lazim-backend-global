...
class MoveInOutPolicy
{
     ...
     *
     * @param  \App\Models\User\User  $user
     * @param  \App\Models\Forms\MoveInOut  $moveInOut
     * @return bool
     */
     ...
     * @return bool
     */
    public function delete(User $user, MoveInOut $moveInOut): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, MoveInOut $moveInOut): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, MoveInOut $moveInOut): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, MoveInOut $moveInOut): bool
    {
