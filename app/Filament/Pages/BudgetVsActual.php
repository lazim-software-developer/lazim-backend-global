...
class BudgetVsActual extends Page implements HasTable
{
    ...
    protected static ?string $title = 'Budget vs Actuals';
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns([
                TextColumn::make('budget.building.name')->sortable(),
                TextColumn::make('service.code')->label('Mollak code')->sortable(),
                TextColumn::make('service.name')->label('Service name')->sortable(),
