...
use App\Models\BuildingEngineer;
...
class BuildingEngineerResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Building Engineer';
    ...
    {
        return [
            'index' => Pages\ListBuildingEngineers::route('/'),
            'create' => Pages\CreateBuildingEngineer::route('/create'),
