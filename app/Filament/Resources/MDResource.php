...
class MDResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'MD';
    ...
    {
        return [
            'index' => Pages\ListMDS::route('/'),
            'create' => Pages\CreateMD::route('/create'),
            'view' => Pages\ViewMD::route('/{record}'),
            'edit' => Pages\EditMD::route('/{record}/edit'),
        ];
    }
}
