...
class LegalOfficerResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Legal Officer';
    ...
    {
        return [
            'index' => Pages\ListLegalOfficers::route('/'),
            'create' => Pages\CreateLegalOfficer::route('/create'),
