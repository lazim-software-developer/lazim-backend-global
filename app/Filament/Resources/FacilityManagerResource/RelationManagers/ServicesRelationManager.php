            ...
            ->headerActions([
                Tables\Actions\AttachAction::make()
                    ...
                    ->recordSelect(function (RelationManager $livewire) {
                        ...
                        $allServices = Service::where('type', '!=', 'inhouse')
                            ->orWhereNull('type')->get()->pluck('id')->toArray();
                        $existingServices = DB::table('service_vendor')
                            ->where('vendor_id', $vendorId)
                            ->whereIn('service_id', $allServices)->pluck('service_id')->toArray();
                        $notSelected = Service::whereNotIn('id', $existingServices)
                            ->where('type', '!=', 'inhouse')
                            ->orWhereNull('type')->get()->pluck('name', 'id')->toArray();
