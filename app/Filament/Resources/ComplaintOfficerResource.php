...
use App\Models\ComplaintOfficer;
...
class ComplaintOfficerResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Complaint Officer';
    ...
    {
        return [
            'index' => Pages\ListComplaintOfficers::route('/'),
            'create' => Pages\CreateComplaintOfficer::route('/create'),
