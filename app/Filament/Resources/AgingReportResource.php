...
class AgingReportResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns([
                TextColumn::make('flat.property_number')->label('Unit')->searchable()->sortable(),
                TextColumn::make('owner.name')->label('Owner')->limit(20)->sortable(),
                TextColumn::make('outstanding_balance')->label('Outstanding Balance')->sortable(),
