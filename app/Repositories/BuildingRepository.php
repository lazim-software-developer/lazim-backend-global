...
class BuildingRepository
{
    ...
    public function list($request)
    {
        return $this->model
            ...
            ->leftJoin('owner_associations', 'buildings.owner_association_id', '=', 'owner_associations.id')
            ->select('buildings.*', 'cities.name as city_name', 'owner_associations.name as owner_associations_name')
