...
//env("MOLLAK_API_URL") . 
    ...
    public function download(Request $request)
    {
        $templateMap = [
            ...
            'e_services' => 'templates/32Qm7m764JK2h2ZjZiWV9rtIkW1F32-metaU2VydmljZXMtUmVxdWVzdHMueGxzeA==-.xlsx',
            'happiness_center' => 'templates/M3pv7wt1DjZz8MDmeWouR2znbSpLYu-metaSGFwcGluZXNzLUNlbnRlci54bHN4-.xlsx',
            'balance_sheet' => 'templates/vldHx3E97s120oHp2ixvrIWvf4HUP1-metaQmFsYW5jZS1TaGVldC54bHN4-.xlsx',
            'general_fund_statement'=> 'templates/BXUUsGs8R6oyJG7GRmxeQZi0wSDIHI-metaR2VuZXJhbC1GdW5kLVN0YXRlbWVudC54bHN4-.xlsx',
            'reserve_fund'=> 'templates/BDVTk6qUjdD2wzWvIEcPhrHa6uD4xC-metaUmVzZXJ2ZS1GdW5kLVN0YXRlbWVudC54bHN4-.xlsx',
            'budget_vs_actual'=> 'templates/2y6P8GPMTku2qX6UaYP41cIpiVsmXu-metaQnVkZ2V0LVZzLUFjdHVhbC54bHN4-.xlsx',
            'accounts_payables'=> 'templates/3c8O2VA74zap1ITm3LGquy17sq7ON9-metaQWNjb3VudHMtUGF5YWJsZXMueGxzeA==-.xlsx',
            'delinquents'=> 'templates/S2pHC3MbEFuSUu5R7R5OLVCYwjKj90-metaRGVsaW5xdWVudC1Pd25lcnMueGxzeA==-.xlsx',
            'collections'=> 'templates/UaxhrxqpCfW4DIN3wJGuaoKWtY6jpF-metaQ29sbGVjdGlvbi1SZXBvcnQueGxzeA==-.xlsx',
            'bank_balance'=> 'templates/xO6cD8gF9ZZrcGsSdaZQnGJeOFt0xv-metaQmFuay1CYWxhbmNlLnhsc3g=-.xlsx',
            'utility_expenses'=> 'templates/GDgsLMpWoG4ip7PuNgy0ChMzS3vQ1p-metaVXRpbGl0eS1FeHBlbnNlcy54bHN4-.xlsx',
            'work_orders'=> 'templates/5IuAOeSqZBoLxiuHmPzrQT3QccZbJz-metaV29yay1PcmRlcnMueGxzeA==-.xlsx',
            'asset_list_and_expenses'=> 'templates/a8BhnZ69xxRq3MYDzyuINWu5vQgouI-metaQXNzZXQtTGlzdHMtYW5kLUV4cGVuc2VzLnhsc3g=-.xlsx',
        ];
