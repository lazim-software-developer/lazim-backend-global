...
class ComplaintController extends Controller
{
    ...
    public function create(ComplaintStoreRequest $request, Building $building)
    {
        ...
        if (Complaint::where(['user_id' => auth()->user()->id, 'complaintable_id' => $complaitableId, 'complaintable_type' => $complaintableClass, 'status' => 'open', 'complaint' => $request->complaint])->exists()) {
            return (new CustomResponseResource([
                'title' => 'Error',
                'message' => 'You have already submitted this complaint.',
                'code' => 403,
            ]))->response()->setStatusCode(403);
