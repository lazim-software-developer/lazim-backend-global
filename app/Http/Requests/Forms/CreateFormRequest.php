...
class CreateFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'handover_acceptance' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'receipt_charges' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'contract' => 'file|mimes:pdf,jpeg,png|max:2048',
            'title_deed' => 'file|mimes:pdf,jpeg,png|max:2048',
            'passport' => 'required_if:type,move-in|file|mimes:pdf,jpeg,png|max:2048',
            'dewa' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'cooling_registration' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'gas_registration' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'vehicle_registration' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'movers_license' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'movers_liability' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'etisalat_final' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',

            'dewa_final' => 'required_if:type, move-out|file|mimes:pdf,jpeg,png|max:2048',
            'gas_clearance' => 'required_if:type, move-out|file|mimes:pdf,jpeg,png|max:2048',
            'cooling_clearance' => 'required_if:type, move-out|file|mimes:pdf,jpeg,png|max:2048',
            'gas_final' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'cooling_final' => 'nullable|file|mimes:pdf,jpeg,png|max:2048',
            'noc_landlord' => 'file|mimes:pdf,jpeg,png|max:2048',
        ];
    }
