...
class MoveoutNotificationJob implements ShouldQueue
{
     ...
     */
    public function __construct(protected $user, protected $moveout, protected $mailCredentials)
    {
        //
    }
    ...
    public function handle(): void
    {
        ...
        $beautymail->send('emails.moveout_notification', ['user' => $this->user, 'moveout' => $this->moveout], function ($message) {
            $message
