...
class CreateUserJob implements ShouldQueue
{
    ...
    public $user;
    public $password;
    public function __construct($user, $password, protected $mailCredentials, protected $pm_oa)
    {
        $this->user     = $user;
    ...
    public function handle(): void
    {
        ...
        $beautymail->send('emails.createUser',
            ['user' => $this->user, 'password' => $this->password, 'pm_oa' => $this->pm_oa], function ($message) {
                $message
