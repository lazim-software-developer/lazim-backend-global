...
class TenantExpiryNotificationJob implements ShouldQueue
{
     ...
     */
    public function __construct(protected $user, protected $tenant, protected $mailCredentials)
    {
        //
    }
    ...
    public function handle(): void
    {
        ...
        $beautymail->send('emails.tenant_expiry_notification', ['user' => $this->user, 'tenant' => $this->tenant], function ($message) {
            $message
